Namespace.register("HMDPS.FrmHMDPSMainMenu");

HMDPS.FrmHMDPSMainMenu = function () {
    var me = new gdmz.base.panel();
    var clsComFnc = new gdmz.common.clsComFnc();
    clsComFnc.GSYSTEM_NAME = "伝票集計システム";
    ...
    me.load = function () {
        ...
        $(".HMDPS.HMDPS-loading-icon").show();
        $(".HMDPS.HMDPS-layout-center fieldset").hide();

        $(".FrmHMDPSMainMenu.Menu")
            .jstree({
                //20240606 caina upd s
                core: {
                    animation: 0,
                    data: {
                        url: "HMDPS/FrmHMDPSMainMenu/menuHMDPS",
                        dataType: "json",
                    },
                    themes: {
                        variant: "small",
            ...
            .bind("select_node.jstree", function (_event, data) {
                ...
                var currentContent = $(
                    ".ui-widget-header.ui-corner-top.HMDPS-ContentBar"
                ).attr("id");
                    ...
                    if (me.blnFlag) {
                        if (nodeID != me.currentFrmID) {
                            ...
                            clsComFnc.MsgBoxBtnFnc.Yes = function () {
                                ...
                                $(".HMDPS.HMDPS-layout-center").css(
                                    "overflow-y",
                                    "hidden"
                                );
                                $(".HMDPS-content-fixed-width").css(
                                    "width",
                                    "1113px"
                                );
                                //20200910 lqs ins E
    ...
    function getSession() {
        var url = "HMDPS/FrmHMDPSMainMenu/getSession";
    ...
    me.getHtml = function (frmID, frmNM, url) {
        ...
        $(".HMDPS.HMDPS-layout-center").html("");

        $.ajax({
            type: "POST",
            url: "HMDPS" + "/FrmHMDPSMainMenu/FncChkUserAuthority",
            data: {
                data: {
                    PRO_ID: "DPY/" + frmID.substr(0, 8) + "_" + frmID.substr(8),
                },
            },
                    ...
                    if (result["data"] == "session is outdate") {
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                $(".HMDPS.HMDPS-layout-center").html(res);
                                $(
                                    ".ui-widget-header.ui-corner-top.HMDPS-ContentBar"
                                ).html(frmNM);
                                $(
                                    ".ui-widget-header.ui-corner-top.HMDPS-ContentBar"
                                ).attr("id", "mainTtl_" + frmID);
...
$(function () {
    var o_HMDPS_FrmHMDPSMainMenu = new HMDPS.FrmHMDPSMainMenu();
    o_HMDPS_FrmHMDPSMainMenu.load();

    o_HMDPS_HMDPS.FrmHMDPSMainMenu = o_HMDPS_FrmHMDPSMainMenu;
});
