...
Namespace.register("HMAUD.HMAUDAdminMente");

HMAUD.HMAUDAdminMente = function () {
    // ==========
    // = 宣言 start =
    // ==========
    ...
    // jqgrid
    me.grid_id = "#HMAUDAdminMente_tblMain";
    ...
    me.controls.push({
        id: ".HMAUDAdminMente.button",
        type: "button",
        handle: "",
    });
    me.controls.push({
        id: ".HMAUDAdminMente.btnRowAdd",
        type: "button",
        handle: "",
    });
    me.controls.push({
        id: ".HMAUDAdminMente.btnRowDel",
        type: "button",
        handle: "",
    });
    me.controls.push({
        id: ".HMAUDAdminMente .btnUpdata",
        type: "button",
        handle: "",
    });
    ...
    //更新ボタンクリック
    $(".HMAUDAdminMente.btnUpdata").click(function () {
        if (!me.repeatCheck()) {
            return false;
        }
    ...
    $(".HMAUDAdminMente.btnRowAdd").click(function () {
        me.btnRowAdd_Click();
    });
    $(".HMAUDAdminMente.btnRowDel").click(function () {
        me.btnRowDel_Click();
    });

    $(".HMAUDAdminMente.btnRetrun").click(function () {
        me.btnRetrun_Click();
    });
    ...
    me.Page_Load = function () {
        ...
        var completeFun = function (_returnFLG, result) {
            if (result["error"]) {
                $(".HMAUDAdminMente.btnRowAdd").button("disable");
                $(".HMAUDAdminMente.btnRowDel").button("disable");
                $(".HMAUDAdminMente.btnUpdata").button("disable");
    ...
    me.setTableSize = function () {
        gdmz.common.jqgrid.set_grid_width(
            me.grid_id,
            $(".HMAUDAdminMente fieldset").width(),
        );
        var mainHeight = $(".HMAUD.HMAUD-layout-center").height();
        var buttonHeight = $(".HMAUDAdminMente.buttonClass").height();
        var fieldsetHeight = $(".HMAUDAdminMente fieldset").height();
    ...
    me.btnUpdata_Click = function () {
        ...
        var url = "HMAUD/HMAUDAdminMente/btnUpdate_Click";
        var data = {
            tableData: objDR,
        };
...
$(function () {
    var o_HMAUD_HMAUDAdminMente = new HMAUD.HMAUDAdminMente();
    o_HMAUD_HMAUDAdminMente.load();
    o_HMAUD_HMAUD.HMAUDAdminMente = o_HMAUD_HMAUDAdminMente;
});
