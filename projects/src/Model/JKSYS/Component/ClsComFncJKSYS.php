...
class ClsComFncJKSYS extends ClsComDb
{
    ...
    public function FncGetBusyoMstValueSQL($strCode)
    {
        $strSql = "";
        //** ＳＱＬ作成
    ...
    public function FncGetBusyoMstValue($strCode)
    {
        return parent::select($this->FncGetBusyoMstValueSQL($strCode));
    }
