...
class FrmOptionInput extends ClsComDb
{
    public $clsComFnc;
    ...
    function fncMeisaiFirstSetSql($conditions)
    {
        ...
        //20170518 Update Start
        $strsql .= " LEFT JOIN  M41E10 M_CMN ON M_CMN.CMN_NO = M_FZK.CMN_NO ";
        //20170518 Update End

        $strsql .= " WHERE  M_FZK.CMN_NO ='" . $conditions['CMN_NO'] . "'";
        $strsql .= " AND   M_FZK.FZH_TKB_KSH_KB = '0'";
    ...
    public function fnc41E12TeikaSumSql($conditions)
    {
        ...
        $strsql .= " FROM   M41E12";
        $strsql .= " WHERE  CMN_NO = '" . $conditions['CMN_NO'] . "' AND FZH_TKB_KSH_KB = '0'";
        return $strsql;
    ...
    public function fncKasouDifTeikaSql($conditions)
    {
        ...
        $strsql .= " AND FUZOKUHINKBN = '0'" . "\r\n";
        $strsql .= " AND KASOUNO <> 'KASOUNO'" . "\r\n";
        // $strsql .= "SELECT SUM(NVL(TEIKA,0)) KASO_TEIKA FROM WK_HKASOUMEISAI";
        // $strsql .= " WHERE CMN_NO = '" . $conditions['CMN_NO'] . "' AND FUZOKUHINKBN = '0' AND KASOUNO <> '" . $conditions['KASOUNO'] . "'";
        //20131206 luchao modify
    ...
    public function fncDeleteKasouMeisaiSql($conditions)
    {
        ...
        $strsql .= " AND KASOUNO = '@KasouNO'" . "\r\n";
        // $strsql .= " WHERE CMN_NO = '" . $conditions['CmnNO'] . "'";
        // $strsql .= " AND KASOUNO = '" . $conditions['KasouNO'] . "'";
        //20131206 luchao modify
        $strsql .= " AND FUZOKUHINKBN = '0'" . "\r\n";
    ...
    public function fncDeleteKasouMeisai($postData = NULL)
    {
        return parent::Do_Execute($this->fncDeleteKasouMeisaiSql($postData));
    }

    public function fncKasouDifTeika($postData = NULL)
    {
    ...
    public function fnc41E12TeikaSum($postData = NULL)
    {
