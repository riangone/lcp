...
// * 処理説明	：機能名のデータ処理クラス
//*************************************
class HMAUDAdminMente extends ClsComDb
{
    ...
    {
        $strSQL = "";
        $strSQL .= " DELETE FROM HMAUD_MST_ADMIN              " . "\r\n";
        return parent::delete($strSQL);
    }

    public function insertADMIN($tableData)
    {
        $strSQL = "";
        $strSQL .= " INSERT INTO HMAUD_MST_ADMIN                  " . "\r\n";
        $strSQL .= " (SYAIN_NO,                                  " . "\r\n";
        $strSQL .= "  CREATE_DATE,                                  " . "\r\n";
