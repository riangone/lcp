 ...
 * @author FCSDL
 */
Namespace.register("HMTVE.HMTVE");

HMTVE.HMTVE = function () {
    ...
    me.load = function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                $(".HMTVE.HMTVE-layout-west").html(result);
                $(".HMTVE.HMTVE-loading-icon").hide();
                $(".ui-widget-content.HMTVE.HMTVE-layout-west").css(
                    "overflow",
                    "scroll"
                );
            },
                    ...
                    if (strTemp != "") {
                        ...
                        if (strTemp != "") {
                            ...
                            if (strTemp != "") {
                                ...
                                //仮名以外1文字
                                strTemp = $.trim(str.substr(i, 1));
                                if (strTemp != "") {
                                    fullStr =
                                        fullStr + str.substr(i, 1) + "<br />";
                                }
                            }
                        }
                    }
    ...
    me.toTwoChar = function (str) {
        ...
        for (var i = 0; i < strTempHalf.length; i += 2) {
            ...
            if (str === str2) {
                return strTempFull.substr(i, 2) + "<br/>";
            }
        }
        return "";
    };
    ...
    me.toOneChar = function (str) {
        ...
        for (var i = 0; i < strTempHalf.length; i += 2) {
            ...
            str2 = strTempHalf.substr(i, 2);
            if (str === str2) {
                return strTempFull.substr(i / 2, 1) + "<br/>";
            }
        }
        return "";
    };
    ...
    me.toChar = function (str) {
        ...
        for (var i = 0; i < strTempHalf.length; i++) {
            ...
            if (str === str2) {
                return strTempFull.substr(i, 1) + "<br/>";
            }
        }
        return "";
    };
