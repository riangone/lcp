 ...
 * -------------------------------------------------------------------------------------------------------
 */
Namespace.register("HDKAIKEI.HDKAIKEI");

HDKAIKEI.HDKAIKEI = function () {
    ...
    me.load = function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                $(".HDKAIKEI.HDKAIKEI-layout-west").html(result);
                $(".HDKAIKEI.HDKAIKEI-loading-icon").hide();
                $(".ui-widget-content.HDKAIKEI.HDKAIKEI-layout-west").css(
                    "overflow",
                    "scroll"
                );
            },
                    ...
                    if (strTemp != "") {
                        ...
                        if (strTemp != "") {
                            ...
                            if (strTemp != "") {
                                ...
                                // if (strTemp != "")
                                {
                                    fullStr = fullStr + str.substring(i, i + 1);
                                }
                            }
                        }
                    }
    ...
    me.toTwoChar = function (str) {
        ...
        for (var i = 0; i < strTempHalf.length; i += 2) {
            ...
            if (str === str2) {
                return strTempFull.substring(i, i + 2);
            }
        }
        return "";
    };
    ...
    me.toOneChar = function (str) {
        ...
        for (var i = 0; i < strTempHalf.length; i += 2) {
            ...
            str2 = strTempHalf.substring(i, i + 2);
            if (str === str2) {
                return strTempFull.substring(i / 2, i / 2 + 1);
            }
        }
        return "";
    };
    ...
    me.toChar = function (str) {
        ...
        for (var i = 0; i < strTempHalf.length; i++) {
            ...
            if (str === str2) {
                return strTempFull.substring(i, i + 1);
            }
        }
        return "";
    };
...
$(function () {
    o_HDKAIKEI_HDKAIKEI = new HDKAIKEI.HDKAIKEI();
    o_HDKAIKEI_HDKAIKEI.load();
});
