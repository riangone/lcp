...
(function (factory) {
     ...
     * Download url: https://github.com/vakata/jstree/blob/master/dist/jstree.js
     */
    /*!
    ...
    $.jstree.core.prototype = {
        ...
        init: function (el, options) {
            ...
            //20240605 zhangxiaolei upd loading => 読み込み中... s
            this.element.html(
                "<" +
                    ...
                    this.get_string("読み込み中 ...") +
                    "</a></li></ul>"
            );
            //20240605 zhangxiaolei upd loading => 読み込み中... e
            this.element.attr(
                ...
                blur: function (e) {
                    ...
                    setTimeout(
                        function () {
                            ...
                            if (node.length) {
                                this._data.core.focused = tmp.id;
                                node.children(".jstree-anchor").trigger(
                                    "focus"
                                );
                            }
                        }.bind(this),
    ...
    $.jstree.plugins.search = function (options, parent) {
        ...
        this.search = function (
            ...
            inside =
                inside && (inside.id || inside.id === 0) ? inside.id : null;
            str = str.toString();
    ...
    $.jstree.plugins.unique = function (options, parent) {
        ...
        this.create_node = function (par, node, pos, callback, is_loaded) {
            if (
                !node ||
                (typeof node === "object" && node.text === undefined)
            ) {
                if (par === null) {
                    par = $.jstree.root;
                }
