...
class rpx_to_pdf
{
    ...
    public function to_pdf()
    {
        ...
        $tcpdf_file = str_replace("JKSYS/Component", "Component", $this->file_path) . "/" . 'tcpdf/tcpdf.php';
        ...
        if (file_exists($rpx_file)) {
            ...
            switch ($this->mode) {
                ...
                case "2":
                    ...
                    break;
                //2013-11-29 zhenghuiyun insert end
                case "1": //SyukkouSeikyuPrint of JKSYS using
                ...
                if ($this->mode != "0") {
                    ...
                    if ($this->mode == "2") {
                        ...
                        if ($tmp_TopMargin_current > $pdf->getPageHeight()) {
                            ...
                            if ($this->rpx_file_name == "rptSyukkouSeikyuPrint") {
                                $this->TopMargin_current = $this->TopMargin_current - 15;
                            }
                        }
                    }
