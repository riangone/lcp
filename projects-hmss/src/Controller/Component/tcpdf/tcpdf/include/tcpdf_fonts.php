...
class TCPDF_FONTS
{
	...
	public static function _putfontwidths($font, $cidoffset = 0)
	{
		...
		//2024/05/24 zhangxiaolei update start
		//http://www.hardworker.jp/blog/2015/08/25/tcpdfー半角カナの幅の計算がおかしい/
		// return '/W ['.$w.' ]';
		return '/W [' . $w . ' 332 389 500 ]';
		//2024/05/24 zhangxiaolei update end
	}
