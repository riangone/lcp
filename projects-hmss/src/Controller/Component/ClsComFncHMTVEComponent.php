...
class ClsComFncHMTVEComponent extends Component
{
    //メンバー変数宣言
    public $xml = "";
    public $xml_path = "";
    ...
    {
        try {
            $this->ClsComFnc = new ClsComFncHMTVE();
    ...
    public function FncGetBusyoMstValue()
    {
        ...
        try {
            ...
            $Do_Execute = $this->ClsComFncHMTVE->FncGetBusyoMstValue();
            if (!$Do_Execute['result']) {
                throw new \Exception($Do_Execute['data']);
            }
