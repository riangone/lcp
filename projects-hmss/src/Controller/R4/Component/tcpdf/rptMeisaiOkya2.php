 ...
 *
 */
function rptMeisaiOkya2(&$key, &$data)
{
    $return["val"] = true;
    ...
    switch ($key) {
        ...
        case "KEIYAKU_NM1":
            ...
            // 20140318 S0006 End
            if (isset($data["KEIYAKU_NM2"]) && FncNv1(rtrim($data["KEIYAKU_NM2"])) == "") {
        ...
        case "KEIYAKU_NM2":
            ...
            // 20140318 S0006 End
            if (isset($data["KEIYAKU_NM2"]) && FncNv1(rtrim($data["KEIYAKU_NM2"])) != "") {
                $data["KEIYAKU_NM2"] = isset($data["KEIYAKU_NM2"]) ? rtrim($data["KEIYAKU_NM2"]) : '' . " 様";
            }
            break;
        case "txtOsiharaikin":
            ...
            $return["val"] = FncNz1($value1) - FncNz1($value2) - FncNz1($value3);
            // $return["val"] = FncNz1($data["OSHIHARAIKEI"] ? rtrim($data["OSHIHARAIKEI"]) : '') - FncNz1($data["SITADORI_SUMI_KIN"] ? rtrim($data["SITADORI_SUMI_KIN"]) : '') - FncNz1($data["SITADORI_SUMI_ZEI"] ? rtrim($data["SITADORI_SUMI_ZEI"]) : '');
            break;
        case "lblKozaMeigi1":
        ...
        case "lblKozaMeigi3":
            ...
            break;
        case "SYARYOU_NEBIKI":
            if (isset($data["SYARYOU_NEBIKI"]) && FncNz1(rtrim($data["SYARYOU_NEBIKI"])) != 0) {
            ...
            break;
        case "YOTAKU_KIN":
            if (isset($data["YOTAKU_KIN"]) && FncNz1(rtrim($data["YOTAKU_KIN"])) != 0) {
        ...
        case "lblPackDe753":
            $lblPackDe753 = "";
            if (isset($data["PACK_DE_753"]) && FncNz1(rtrim($data["PACK_DE_753"])) != 0) {
                $lblPackDe753 = "バックDE753";
                $lblPackName = "・メンテ";
            }
            if (isset($data["ENCHOU_HOSYOU"]) && FncNz1(rtrim($data["ENCHOU_HOSYOU"])) != 0) {
                if ($lblPackDe753 != "") {
                ...
                //$data["PACK_DE_753"] = number_format(  FncNv1(rtrim($data["PACK_DE_753"])) +   FncNv1(rtrim($data["ENCHOU_HOSYOU"])));
            }
            if (isset($data["PACK_DE_MENTE"]) && FncNz1(rtrim($data["PACK_DE_MENTE"])) != 0) {
        ...
        case "PACK_DE_753":
            ...
            $value2 = '';
            $value3 = '';
            if (isset($data["PACK_DE_753"]) && FncNv1(rtrim($data["PACK_DE_753"])) != 0) {
                $value1 = isset($data["PACK_DE_753"]) ? rtrim($data["PACK_DE_753"]) : '';
            }
            if (isset($data["PACK_DE_MENTE"]) && FncNv1(rtrim($data["PACK_DE_MENTE"])) != 0) {
                $value2 = isset($data["PACK_DE_MENTE"]) ? rtrim($data["PACK_DE_MENTE"]) : '';
            }
            if (isset($data["ENCHOU_HOSYOU"]) && FncNv1(rtrim($data["ENCHOU_HOSYOU"])) != 0) {
                $value3 = isset($data["ENCHOU_HOSYOU"]) ? rtrim($data["ENCHOU_HOSYOU"]) : '';
            }
            $data["PACK_DE_753"] = FncNz1($value1) + FncNz1($value2) + FncNz1($value3);
...
//処理説明：Null変換(文字)を行う。
//**********************************************************************
//	function FncNv1($objValue, $objReturn = "")
//	{
//		//---NULLの場合---
//		if ($objValue == null)
//		{
