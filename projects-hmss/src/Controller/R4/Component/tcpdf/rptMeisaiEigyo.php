 ...
 *
 */
function rptMeisaiEigyo(&$key, &$data)
{
    ...
    switch ($key) {
        ...
        case "txtOsiharaikin":
            ...
            // $return["val"] = FncNz1(rtrim($data["OSHIHARAIKEI"])) - FncNz1($data["SITADORI_SUMI_KIN"] ? rtrim($data["SITADORI_SUMI_KIN"]) : '') - FncNz1($data["SITADORI_SUMI_ZEI"] ? rtrim($data["SITADORI_SUMI_ZEI"]) : '');
            break;
        case "lblKozameigi1":
